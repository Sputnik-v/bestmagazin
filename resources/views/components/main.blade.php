<div class="border-r-2 border-gray-900">
    <p class="text-right text-gray-900 p-4 text-xl bg-gray-100 w-full bg-yellow-400">
        {{\Illuminate\Support\Facades\Route::getCurrentRoute()->uri !== '/' ? \Illuminate\Support\Facades\Route::getCurrentRoute()->uri : 'New products'}}</p>
